...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
    ...
    var n = number === null || number === undefined || number === '' ? 0 : number;
    var asString = typeof n === "string" ? n : typeof n.toString === 'function' ? n.toString() : String(n);
    var parts = asString.split(".");
    if (!Array.isArray(parts) || parts.length === 0) return "0";
    if (dec <= 0) return parts[0];
    var fraction = parts[1] || "";
    if (fraction.length > dec) return "".concat(parts[0], ".").concat(fraction.substr(0, dec));
    while (fraction.length < dec) fraction += "0";
    return "".concat(parts[0], ".").concat(fraction);
...
var render = function render() {
  ...
  return _c('div', {
    ...
    attrs: {
      "value": _vm.selectedClientPoints,
      "disabled": ""
    }
  }), _vm._v(" "), _c('b-input-group-append', [_c('b-button', {
    style: _vm.pointsConverted ? 'border: 1px solid #9CA3AF' : '',
    attrs: {
      "variant": _vm.pointsConverted ? 'secondary' : 'primary',
      "disabled": _vm.selectedClientPoints === 0
    },
    on: {
      "click": _vm.convertPointsToDiscount
    }
  }, [_vm._v("\n                            " + _vm._s(_vm.pointsConverted ? '✅' : _vm.$t('Convert')) + "\n                          ")])], 1)], 1), _vm._v(" "), _vm.discount_from_points > 0 ? _c('small', {
  ...
  })], 1)], 1) : _vm._e(), _vm._v(" "), _vm.currentUserPermissions && _vm.currentUserPermissions.includes('edit_tax_discount_shipping_sale') ? _c('b-col', {
    attrs: {
      "lg": "6",
      "md": "6",
      "sm": "12"
