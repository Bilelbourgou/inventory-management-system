  ...
  methods: {
    ...
    Get_Product_Details: function Get_Product_Details(product_id, variant_id) {
      ...
      axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
        ...
        _this8.product.Unit_price_wholesale = response.data.Unit_price_wholesale;
        _this8.product.wholesale_Net_price = response.data.wholesale_Net_price;
        _this8.product.min_price = response.data.min_price;
        // baselines for toggle
        _this8.product.retail_unit_price = response.data.Unit_price;
        _this8.product.wholesale_unit_price = response.data.Unit_price_wholesale;
        _this8.product.price_type = 'retail';
        ...
        if (_this8.product.Net_price < (_this8.product.min_price || 0)) {
          _this8.product.price_type = 'retail';
        }
        _this8.add_product();
        _this8.Calcul_Total();
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/".concat(id, "/edit")).then(function (response) {
        ...
        _this9.point_to_amount_rate = response.data.point_to_amount_rate;
        _this9.discount_from_points = response.data.discount_from_points;
        _this9.used_points = _this9.sale.used_points > 0 ? _this9.sale.used_points : 0;
