...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    anyCreditCardUsed: function anyCreditCardUsed(newVal) {
      if (newVal) {
  ...
  computed: {
    ...
    selectedCardsByLineIds: function selectedCardsByLineIds() {
      var result = {};
      var map = this.selectedCardByLine || {};
  ...
  methods: {
    isSavedMode: function isSavedMode(lineIndex) {
      var map = this.displaySavedPaymentMethodsByLine || {};
      return !!map[lineIndex];
    },
    isLineLoadingSavedCards: function isLineLoadingSavedCards(lineIndex) {
      var map = this.submit_showing_credit_card_by_line || {};
      return !!map[lineIndex];
    },
    hasAnyNewCardToTokenize: function hasAnyNewCardToTokenize() {
      var _this3 = this;
      return (this.paymentLines || []).some(function (line, idx) {
        return _this3.isLineCreditCard(line) && !(_this3.selectedCardByLine && _this3.selectedCardByLine[idx]);
      });
    },
    getDefaultSavedCard: function getDefaultSavedCard() {
      var id = this.card_id;
      if (!id) return null;
      var list = Array.isArray(this.localSavedPaymentMethods) ? this.localSavedPaymentMethods : [];
      return list.find(function (c) {
        return c && c.card_id && String(c.card_id) === String(id);
      }) || null;
    },
    formatCardExpiry: function formatCardExpiry(card) {
      var pre = card && card.exp;
      if (pre && String(pre).trim()) return String(pre).trim();
      var m = card && (card.exp_month || card.card_exp_month);
      var y = card && (card.exp_year || card.card_exp_year);
      var month = Number(m);
      var year = Number(y);
      if (!Number.isFinite(month) || month < 1 || month > 12 || !Number.isFinite(year)) return '—';
      var mm = month < 10 ? "0".concat(month) : String(month);
      var yyyy = String(year);
      var yy = yyyy.length === 2 ? yyyy : yyyy.slice(-2);
      return "".concat(mm, "/").concat(yy);
    },
    ...
    show_new_credit_card: function show_new_credit_card(lineIndex) {
      var _this4 = this;
      ...
      if (this.selectedCardByLine && Object.prototype.hasOwnProperty.call(this.selectedCardByLine, this.activeCardLineIndex)) {
        try {
          this.$delete ? this.$delete(this.selectedCardByLine, this.activeCardLineIndex) : delete this.selectedCardByLine[this.activeCardLineIndex];
        } catch (e) {/* ignore */}
      }
    ...
    show_saved_credit_card: function show_saved_credit_card(lineIndex) {
      ...
      if (!this.selectedCardByLine || !this.selectedCardByLine[this.activeCardLineIndex]) {
        var def = this.getDefaultSavedCard();
        if (def) {
    ...
    isSelectedCard: function isSelectedCard(card) {
    ...
    isSelectedCardForLine: function isSelectedCardForLine(card, lineIndex) {
      if (!card) return false;
      var entry = this.selectedCardByLine && this.selectedCardByLine[lineIndex];
    ...
    selectCardForLine: function selectCardForLine(card, lineIndex) {
      if (!this.selectedCardByLine) this.selectedCardByLine = {};
      this.$set ? this.$set(this.selectedCardByLine, lineIndex, card) : this.selectedCardByLine[lineIndex] = card;
    },
    onCreditCardSelected: function onCreditCardSelected() {
      var _this5 = this;
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              _this5.show_new_credit_card(_this5.activeCardLineIndex || 0);
              return _context.a(2);
            case 1:
              // mark only the active line as loading
              if (!_this5.submit_showing_credit_card_by_line) _this5.submit_showing_credit_card_by_line = {};
              _this5.$set ? _this5.$set(_this5.submit_showing_credit_card_by_line, _this5.activeCardLineIndex, true) : _this5.submit_showing_credit_card_by_line[_this5.activeCardLineIndex] = true;
              _this5.submit_showing_credit_card = true;
              _this5.selectedCard = null;
              _this5.card_id = '';
              // Fetch saved payment methods for this client
              _context.n = 2;
              return axios.get("/retrieve-customer?customerId=".concat(_this5.clientId));
            case 2:
              response = _context.v;
              _this5.localSavedPaymentMethods = response && response.data && response.data.data ? response.data.data : [];
              _this5.card_id = response && response.data && response.data.customer_default_source ? response.data.customer_default_source : '';
              _this5.hasSavedPaymentMethod = Array.isArray(_this5.localSavedPaymentMethods) && _this5.localSavedPaymentMethods.length > 0;
              _this5.useSavedPaymentMethod = _this5.hasSavedPaymentMethod;
              _this5.is_new_credit_card = !_this5.hasSavedPaymentMethod;
              // Only affect the active line to avoid leaking selection to other lines
              if (_this5.hasSavedPaymentMethod) {
                _this5.show_saved_credit_card(_this5.activeCardLineIndex || 0);
              } else {
                _this5.show_new_credit_card(_this5.activeCardLineIndex || 0);
              }
              _context.n = 4;
            ...
            case 4:
              ...
              if (_this5.submit_showing_credit_card_by_line && Object.prototype.hasOwnProperty.call(_this5.submit_showing_credit_card_by_line, _this5.activeCardLineIndex)) {
                try {
                  _this5.$set ? _this5.$set(_this5.submit_showing_credit_card_by_line, _this5.activeCardLineIndex, false) : _this5.submit_showing_credit_card_by_line[_this5.activeCardLineIndex] = false;
                } catch (e) {/* ignore */}
              }
    ...
    loadStripePayment: function loadStripePayment(lineIndex) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var idx, containerId, mountSelector, container, elements, element, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.n = 2;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)("".concat(_this6.stripeKey));
            case 2:
            ...
            case 3:
              ...
              return _context2.a(2);
            case 4:
              idx = typeof lineIndex === 'number' ? lineIndex : _this6.activeCardLineIndex || 0;
              containerId = "card-element-".concat(idx);
              mountSelector = "#".concat(containerId);
              ...
              return _context2.a(2);
            case 5:
              if (!_this6.cardElementsByLine[idx]) {
                ...
                try {
                  element.on && element.on('change', function (event) {
                    _this6.isCardInputComplete = !!(event && event.complete);
                  });
                } catch (e) {/* ignore */}
                _this6.cardElementsByLine[idx] = element;
              }
              _context2.n = 7;
              break;
            case 6:
    ...
    destroyCardElementForLine: function destroyCardElementForLine(lineIndex) {
      try {
        var idx = typeof lineIndex === 'number' ? lineIndex : this.activeCardLineIndex || 0;
        var el = this.cardElementsByLine && this.cardElementsByLine[idx];
        if (el && el.unmount) {
          el.unmount();
        }
    ...
    destroyAllCardElements: function destroyAllCardElements() {
      ...
      try {
        ...
        keys.forEach(function (k) {
          var el = _this7.cardElementsByLine[k];
          if (el && el.unmount) {
            try {
              el.unmount();
            } catch (e) {/* ignore */}
    ...
    reindexLineStateAfterRemoval: function reindexLineStateAfterRemoval(removedIndex) {
      // Rebuild selectedCardByLine with shifted indices
      var oldSel = this.selectedCardByLine || {};
      var newSel = {};
      Object.keys(oldSel).forEach(function (k) {
        var i = Number(k);
        if (Number.isNaN(i)) return;
        if (i < removedIndex) newSel[i] = oldSel[i];else if (i > removedIndex) newSel[i - 1] = oldSel[i];
      });
      this.selectedCardByLine = newSel;

      // Rebuild saved-mode map with shifted indices
      var oldSaved = this.displaySavedPaymentMethodsByLine || {};
      var newSaved = {};
      Object.keys(oldSaved).forEach(function (k) {
        var i = Number(k);
        if (Number.isNaN(i)) return;
        if (i < removedIndex) newSaved[i] = oldSaved[i];else if (i > removedIndex) newSaved[i - 1] = oldSaved[i];
      });
      this.displaySavedPaymentMethodsByLine = newSaved;

      // Rebuild per-line loading map
      var oldLoading = this.submit_showing_credit_card_by_line || {};
      var newLoading = {};
      Object.keys(oldLoading).forEach(function (k) {
        var i = Number(k);
        if (Number.isNaN(i)) return;
        if (i < removedIndex) newLoading[i] = oldLoading[i];else if (i > removedIndex) newLoading[i - 1] = oldLoading[i];
      });
    ...
    Invoice_POS: function Invoice_POS(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var response, invoicePayload, _t3;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 1:
              ...
              _this9.$emit('invoice-ready', invoicePayload);
              if (typeof NProgress !== 'undefined') {
                NProgress.done();
              }
              // Directly trigger print dialog without showing any modal
              setTimeout(function () {
                return _this9.print_pos();
              }, 300);
              _context4.n = 3;
              break;
            case 2:
    ...
    processPayment: function processPayment() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var newCardIndices, missing, tokenResults, tokensByLine, idx, lineKey, res, token, firstIdx, payload, response, _t5;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 3:
              ...
              newCardIndices = (_this0.paymentLines || []).map(function (line, i) {
                var needsNew = _this0.isLineCreditCard(line) && !(_this0.selectedCardByLine && _this0.selectedCardByLine[i]);
                return needsNew ? i : null;
              }).filter(function (i) {
                return i !== null;
              }); // Validate that each such line has a mounted element
              missing = newCardIndices.find(function (i) {
                return !_this0.cardElementsByLine || !_this0.cardElementsByLine[i];
              });
            ...
            case 4:
              ...
              return Promise.all(newCardIndices.map(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(i) {
                  var _t4;
                  return _regenerator().w(function (_context5) {
                    while (1) switch (_context5.p = _context5.n) {
                      case 0:
                        _context5.p = 0;
                        _context5.n = 1;
                        return _this0.stripe.createToken(_this0.cardElementsByLine[i]);
                      case 1:
            ...
            case 5:
              tokenResults = _context6.v;
              tokensByLine = {};
              idx = 0;
            case 6:
              if (!(idx < tokenResults.length)) {
                _context6.n = 9;
                break;
              }
              lineKey = newCardIndices[idx];
              res = tokenResults[idx] || {};
              if (!res.error) {
                _context6.n = 7;
                break;
              }
            ...
            case 9:
              ...
              token = null;
              if (_this0.activeCardLineIndex != null && tokensByLine[_this0.activeCardLineIndex]) {
                token = {
                  id: tokensByLine[_this0.activeCardLineIndex]
                };
              } else {
              ...
              payload = {
                ...
                details: _this0.details,
                GrandTotal: _this0.grandTotal || _this0.paymentForm.amountDue || _this0.totalPaid,
                // Multi-payment array with optional per-line account and saved card
                payments: (_this0.paymentLines || []).map(function (l, idx) {
                  return {
                    amount: Number(l.amount) || 0,
                    payment_method_id: l.paymentMethodId,
                    account_id: l.accountId || _this0.paymentForm.accountId || null,
                    selected_card_id: _this0.selectedCardsByLineIds && _this0.selectedCardsByLineIds[idx] ? _this0.selectedCardsByLineIds[idx] : null
                  };
                }),
                send_email: _this0.sendEmail,
                send_sms: _this0.sendSMS,
                account_id: _this0.paymentForm.accountId,
                payment_note: _this0.paymentNote || '',
                token: token && token.id ? token.id : null,
                is_new_credit_card: _this0.hasAnyNewCardToTokenize(),
                selected_cards_by_line: _this0.selectedCardsByLineIds,
                card_tokens_by_line: tokensByLine,
                selectedCard: _this0.selectedCard,
                card_id: _this0.card_id,
                discount_from_points: _this0.discountFromPoints || 0,
                used_points: _this0.usedPoints || 0,
                draft_sale_id: _this0.draftSaleId || null
              };
              _context6.n = 10;
              return axios.post(_this0.createPosUrl, payload);
            case 10:
    ...
    CreatePOS: function CreatePOS() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var zeroTotal, total, due, multi, anyNewCard, needsNewCard, payload, response, _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              ...
              zeroTotal = _this1.totalPaid <= 0;
              if (!(!_this1.paymentLines.length || zeroTotal && _this1.paymentLines.length > 1)) {
                _context7.n = 1;
                break;
              }
              if (typeof NProgress !== 'undefined') NProgress.done();
              _this1.makeToast('danger', _this1.$t ? _this1.$t('InvalidData') : 'Invalid data', _this1.$t ? _this1.$t('Failed') : 'Failed');
              return _context7.a(2);
            case 1:
              // Account selection is optional per line; proceed even if unset
              // Validate multi-payment overpay like old POS
              total = parseFloat(_this1.totalPaid);
              due = parseFloat((_this1.paymentForm.amountDue || _this1.grandTotal || 0).toFixed(2));
              multi = _this1.paymentLines.length > 1;
              if (!(multi && total > due)) {
                _context7.n = 2;
                break;
              }
              _this1.makeToast('warning', _this1.$t ? _this1.$t('TotalPaidExceedsGrandTotalForMultiPayment') : 'Total paid exceeds grand total for multiple payments', _this1.$t ? _this1.$t('Warning') : 'Warning');
              if (typeof NProgress !== 'undefined') NProgress.done();
              return _context7.a(2);
            case 2:
              // Determine if any line requires a new card entry (no saved card selected)
              anyNewCard = _this1.hasAnyNewCardToTokenize();
              if (!anyNewCard) {
                _context7.n = 7;
                break;
              }
              ...
              _this1.makeToast('danger', _this1.$t ? _this1.$t('credit_card_account_not_available') : 'Credit card not available', _this1.$t ? _this1.$t('Failed') : 'Failed');
              if (typeof NProgress !== 'undefined') NProgress.done();
              return _context7.a(2);
            case 3:
              if (_this1.stripe) {
              ...
              _this1.makeToast('danger', _this1.$t ? _this1.$t('Failed_to_load') : 'Failed to load.', _this1.$t ? _this1.$t('Failed') : 'Failed');
              if (typeof NProgress !== 'undefined') NProgress.done();
              return _context7.a(2);
            case 4:
              // Ensure at least one card element exists for any card lines requiring new card entry
              needsNewCard = Object.keys(_this1.cardElementsByLine || {}).some(function (i) {
                var li = Number(i);
                var line = (_this1.paymentLines || [])[li];
                var usingSaved = _this1.selectedCardByLine && _this1.selectedCardByLine[li];
                return _this1.isLineCreditCard(line) && !usingSaved;
              });
              if (needsNewCard) {
                _context7.n = 5;
                break;
              }
              _this1.makeToast('danger', _this1.$t ? _this1.$t('Please_enter_credit_card_details') : 'Please enter credit card details', _this1.$t ? _this1.$t('Warning') : 'Warning');
              if (typeof NProgress !== 'undefined') NProgress.done();
              return _context7.a(2);
            case 5:
              _context7.n = 6;
              return _this1.processPayment();
            case 6:
              return _context7.a(2);
            case 7:
              // Non-card / saved card path
              _this1.paymentProcessing = true;
              _this1.isSubmitting = true;
              _context7.p = 8;
              payload = {
                client_id: _this1.clientId,
                warehouse_id: _this1.warehouseId,
                tax_rate: _this1.sale && _this1.sale.tax_rate ? _this1.sale.tax_rate : 0,
                TaxNet: _this1.sale && _this1.sale.TaxNet ? _this1.sale.TaxNet : 0,
                discount: _this1.sale && _this1.sale.discount ? _this1.sale.discount : 0,
                shipping: _this1.sale && _this1.sale.shipping ? _this1.sale.shipping : 0,
                notes: _this1.saleNote || _this1.sale && _this1.sale.notes || '',
                details: _this1.details,
                GrandTotal: _this1.grandTotal || _this1.paymentForm.amountDue || total,
                // Multi-payment array including per-line account (no global)
                payments: (_this1.paymentLines || []).map(function (l, idx) {
                  return {
                    amount: Number(l.amount) || 0,
                    payment_method_id: l.paymentMethodId,
                    account_id: l.accountId || null,
                    selected_card_id: _this1.selectedCardsByLineIds && _this1.selectedCardsByLineIds[idx] ? _this1.selectedCardsByLineIds[idx] : null
                  };
                }),
                send_email: _this1.sendEmail,
                send_sms: _this1.sendSMS,
                // No global account_id
                payment_note: _this1.paymentNote || '',
                is_new_credit_card: _this1.hasAnyNewCardToTokenize(),
                selectedCard: _this1.selectedCard,
                card_id: _this1.card_id,
                selected_cards_by_line: _this1.selectedCardsByLineIds,
                discount_from_points: _this1.discountFromPoints || 0,
                used_points: _this1.usedPoints || 0,
                draft_sale_id: _this1.draftSaleId || null
              };
              _context7.n = 9;
              return axios.post(_this1.createPosUrl, payload);
            case 9:
              ...
              // Prefer parent's Invoice_POS if available (ensures existing invoice modal/printing works)
              if (!(_this1.$parent && typeof _this1.$parent.Invoice_POS === 'function')) {
                _context7.n = 11;
                break;
              }
              _context7.n = 10;
              return _this1.$parent.Invoice_POS(response.data.id);
            case 10:
              _context7.n = 12;
              break;
            case 11:
              _context7.n = 12;
              return _this1.Invoice_POS(response.data.id);
            case 12:
              _this1.$emit('payment-success', {
                id: response.data.id,
                payload: payload
              });
              _this1.$refs.paymentModal && _this1.$refs.paymentModal.hide && _this1.$refs.paymentModal.hide();
              _context7.n = 14;
              break;
            case 13:
              if (typeof NProgress !== 'undefined') NProgress.done();
...
/* harmony import */ var _components_ModernPaymentModal_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ModernPaymentModal.vue */ "./resources/src/views/app/components/ModernPaymentModal.vue");
var _objectSpread2;
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    ModernPaymentModal: _components_ModernPaymentModal_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  metaInfo: {
    title: "POS"
  },
  ...
  methods: _objectSpread(_objectSpread({
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              _context5.n = 1;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_5__.loadStripe)("".concat(_this1.stripe_key));
            case 1:
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "CalculTotal", function CalculTotal() {
    this.total = 0;
    ...
    var _this13 = this;
    return axios.get("/show_product_data/" + product_id + "/" + variant_id + "/" + this.sale.warehouse_id).then(function (response) {
      _this13.product.discount = response.data.discount;
      _this13.product.DiscountNet = response.data.DiscountNet;
      _this13.product.discount_Method = response.data.discount_method;
      _this13.product.product_id = response.data.id;
      _this13.product.product_type = response.data.product_type;
      ...
      _this13.product.Unit_price_wholesale = response.data.Unit_price_wholesale;
      _this13.product.wholesale_Net_price = response.data.wholesale_Net_price;
      _this13.product.min_price = response.data.min_price || 0;
      _this13.product.retail_unit_price = response.data.Unit_price;
      _this13.product.wholesale_unit_price = response.data.Unit_price_wholesale;
      ...
      _this13.product.code = response.data.code;
      _this13.product.fix_price = response.data.fix_price;
      _this13.product.sale_unit_id = response.data.sale_unit_id;
      _this13.product.is_imei = response.data.is_imei;
      _this13.product.imei_number = '';

      // Set current stock quantity from warehouse data
      _this13.product.current = response.data.qte_sale || 0;
      _this13.product.fix_stock = response.data.qte || 0;
      ...
      _this13.add_product(response.data.code);
      _this13.CalculTotal();
    ...
    try {
      ...
      if (min > 0 && currentNet < min) {
        ...
        if (taxMethod === '1') {
          ...
          var _net = taxBase - _tax;
          newItem.Unit_price = parseFloat(unitPriceCandidate.toFixed(2));
          newItem.DiscountNet = parseFloat(_discountNet.toFixed(2));
          newItem.taxe = parseFloat(_tax.toFixed(2));
          newItem.Net_price = parseFloat(_net.toFixed(2));
          newItem.Total_price = parseFloat((_net + _tax).toFixed(2));
        }
    ...
    this.Get_Product_Details(product.id, product.product_variant_id)["catch"](function () {})["finally"](function () {
  ...
  }), "onChangePriceType", function onChangePriceType(detail) {
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        ...
        var product_filter = _this20.products_pos.filter(function (product) {
          return product.code === _this20.search_input || product.barcode.includes(_this20.search_input);
        });
        if (product_filter.length === 1) {
          ...
          _this20.product_filter = _this20.products_pos.filter(function (product) {
            return product.name.toLowerCase().includes(_this20.search_input.toLowerCase()) || product.code.toLowerCase().includes(_this20.search_input.toLowerCase()) || product.barcode.toLowerCase().includes(_this20.search_input.toLowerCase());
          });
        }
      }, 800);
    } else {
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "Products_by_Category", function Products_by_Category(id) {
    this.category_id = id;
    this.getProducts(1);
    ...
    axios.get("pos/data_draft_convert_sale/".concat(id)).then(function (response) {
      ...
      if (_this23.sale.warehouse_id) {
        _this23.Get_Products_By_Warehouse(_this23.sale.warehouse_id);
        _this23.getProducts(1);
      }
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "onPerPageChange", function onPerPageChange(_ref3) {
    ...
    axios.get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&is_sale=" + 1 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
      _this26.products_pos = response.data;
      // If main product list is already loaded, also mark ready
      if (Array.isArray(_this26.products) && _this26.products.length >= 0) {
    ...
    var _this27 = this;
    return axios.get("get_units?id=" + value).then(function (_ref4) {
      var data = _ref4.data;
      return _this27.units = data;
    });
  }), "Modal_Updat_Detail", function Modal_Updat_Detail(detail) {
    var _this28 = this;
    this.detailLoading = true;
    ...
    this.get_units(detail.product_id)["catch"](function () {})["finally"](function () {
      ...
      _this28.detail.retail_unit_price = detail.retail_unit_price !== undefined ? detail.retail_unit_price : detail.Unit_price;
      _this28.detail.wholesale_unit_price = detail.wholesale_unit_price !== undefined ? detail.wholesale_unit_price : detail.Unit_price_wholesale;
      ...
      _this28.detail.tax_method = detail.tax_method;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
      var client, response, data, _t5;
      return _regenerator().w(function (_context8) {
        while (1) switch (_context8.p = _context8.n) {
          case 0:
            _this31.client_name = '';
            _this31.selectedClientPoints = 0;
            _this31.points_to_convert = 0;
            _this31.discount_from_points = 0;
            _this31.used_points = 0;
            _this31.clientIsEligible = false;
            _this31.pointsConverted = false;
            _this31.sale.discount = 0;
            ...
            _this31.selectedClientId = selectedClientId;
            _context8.p = 1;
            _context8.n = 2;
          ...
          case 2:
            ...
            data = response.data;
            if (data.is_royalty_eligible) {
              _this31.selectedClientPoints = data.points;
              _this31.clientIsEligible = true;
            } else {
              _this31.selectedClientPoints = 0;
              _this31.clientIsEligible = false;
            }
          ...
          case 3:
            _context8.p = 3;
            _t5 = _context8.v;
            console.error('Error fetching client points:', _t5);
          case 4:
            _this31.CalculTotal();
          case 5:
    ...
    this.CalculTotal();
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "onPointsToConvertInput", function onPointsToConvertInput() {
    ...
    axios.get("sales_print_invoice/".concat(id)).then(function (response) {
      _this32.invoice_pos.sale = response.data.sale;
      _this32.invoice_pos.details = response.data.details;
      _this32.invoice_pos.setting = response.data.setting;
      _this32.invoice_pos.symbol = response.data.symbol;
      _this32.invoice_pos.zatca_qr = response.data.zatca_qr;
      _this32.payments = response.data.payments;
      _this32.pos_settings = response.data.pos_settings;
      // Mirror index_sale behavior: show modal first, then optionally auto-print
      setTimeout(function () {
        try {
          _this32.$bvModal.show('Show_invoice');
        } catch (e) {}
        _this32.$nextTick(function () {
          return _this32.renderZatcaQrPos();
        });
      }, 500);
    ...
    try {
      ...
      var draw = function draw() {
        try {
          ...
          var text = String(_this33.invoice_pos.zatca_qr || '');
          try {
            var m = _this33.$refs.zatcaQrcodePos;
    ...
    axios.post("clients", {
      ...
      _this35.$bvModal.hide("New_Customer");
    })["catch"](function () {
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    ...
    var _this36 = this;
    axios.get("get_clients_without_paginate").then(function (_ref6) {
      var data = _ref6.data;
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "getResultValue", function getResultValue(result) {
    return result.code + " " + "(" + result.name + ")";
  }), "SearchProduct", function SearchProduct(result) {
    if (this.load_product) {
      this.load_product = false;
    ...
    try {
      ...
      var ps = data && data.pos_settings ? data.pos_settings : {};
      ...
      var rows = details.map(function (d) {
        var qty = d && _this38.formatNumber ? _this38.formatNumber(d.quantity, 2) : d ? d.quantity : '';
        var unit = d && d.unit_sale ? d.unit_sale : '';
        var price = d && _this38.formatNumber ? _this38.formatNumber((d.total || 0) / (d.quantity || 1), 2) : '';
        var total = d && _this38.formatNumber ? _this38.formatNumber(d.total || 0, 2) : d ? d.total : '';
        var imei = d && d.is_imei && d.imei_number ? "<br><span>".concat(_this38.$t ? _this38.$t('IMEI_SN') : 'IMEI/SN', " : ").concat(d.imei_number, "</span><br>") : '<br>';
        return "\n            <tr>\n              <td colspan=\"3\">".concat(d && d.name || '', "\n                ").concat(imei, "\n                <span>").concat(qty, " ").concat(unit, " x ").concat(price, "</span>\n              </td>\n              <td style=\"text-align:right;vertical-align:bottom\">").concat(total, "</td>\n            </tr>\n          ");
      }).join('');
      var totalVal = s.GrandTotal != null ? s.GrandTotal : s.grand_total != null ? s.grand_total : 0;
      var taxe = s.taxe != null ? s.taxe : 0;
      var taxRate = s.tax_rate != null ? s.tax_rate : 0;
      var discount = s.discount != null ? s.discount : 0;
      var shipping = s.shipping != null ? s.shipping : 0;
      var paidAmount = s.paid_amount != null ? s.paid_amount : 0;
      var dueAmount = Math.max(0, Number(totalVal) - Number(paidAmount));
      var totals = "\n          ".concat(ps && ps.show_discount ? "<tr><td colspan=\"3\" class=\"total\">".concat(this.$t ? this.$t('OrderTax') : 'OrderTax', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(taxe, 2) : taxe, " (").concat(this.formatNumber ? this.formatNumber(taxRate, 2) : taxRate, " %)</td></tr>") : '', "\n          ").concat(ps && ps.show_discount ? "<tr><td colspan=\"3\" class=\"total\">".concat(this.$t ? this.$t('Discount') : 'Discount', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(discount, 2) : discount, "</td></tr>") : '', "\n          ").concat(ps && ps.show_discount ? "<tr><td colspan=\"3\" class=\"total\">".concat(this.$t ? this.$t('Shipping') : 'Shipping', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(shipping, 2) : shipping, "</td></tr>") : '', "\n          <tr><td colspan=\"3\" class=\"total\">").concat(this.$t ? this.$t('Total') : 'Total', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(totalVal, 2) : totalVal, "</td></tr>\n          ").concat(Number(paidAmount) < Number(totalVal) ? "<tr><td colspan=\"3\" class=\"total\">".concat(this.$t ? this.$t('Paid') : 'Paid', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(paidAmount, 2) : paidAmount, "</td></tr>") : '', "\n          ").concat(Number(paidAmount) < Number(totalVal) ? "<tr><td colspan=\"3\" class=\"total\">".concat(this.$t ? this.$t('Due') : 'Due', "</td><td style=\"text-align:right\" class=\"total\">").concat(symbol, " ").concat(this.formatNumber ? this.formatNumber(dueAmount, 2) : dueAmount, "</td></tr>") : '', "\n        ");
      var paymentsTable = Number(paidAmount) > 0 ? "\n          <table class=\"change mt-3\" style=\"font-size: 10px;\">\n            <thead>\n              <tr style=\"background: #eee; \">\n                <th style=\"text-align: left;\" colspan=\"1\">".concat(this.$t ? this.$t('PayeBy') : 'Pay By', "</th>\n                <th style=\"text-align: center;\" colspan=\"2\">").concat(this.$t ? this.$t('Amount') : 'Amount', "</th>\n                <th style=\"text-align: right;\" colspan=\"1\">").concat(this.$t ? this.$t('Change') : 'Change', "</th>\n              </tr>\n            </thead>\n            <tbody>\n              ").concat(payments.map(function (p) {
        var method = p && p.payment_method && p.payment_method.name ? p.payment_method.name : '---';
        var amount = _this38.formatNumber ? _this38.formatNumber(p && p.montant ? p.montant : 0, 2) : p && p.montant ? p.montant : 0;
        var change = _this38.formatNumber ? _this38.formatNumber(p && p.change ? p.change : 0, 2) : p && p.change ? p.change : 0;
        return "<tr><td style=\"text-align:left\" colspan=\"1\">".concat(method, "</td><td style=\"text-align:center\" colspan=\"2\">").concat(amount, "</td><td style=\"text-align:right\" colspan=\"1\">").concat(change, "</td></tr>");
      }).join(''), "\n            </tbody>\n          </table>\n        ") : '';
      var contactLines = "\n          <span>".concat(this.$t ? this.$t('date') : 'date', " : ").concat(s.date || '', " <br></span>\n          <span>").concat(this.$t ? this.$t('Seller') : 'Seller', " : ").concat(s.seller_name || '', " <br></span>\n          ").concat(ps && ps.show_address ? "<span>".concat(this.$t ? this.$t('Adress') : 'Address', " : ").concat(set.CompanyAdress || '', " <br></span>") : '', "\n          ").concat(ps && ps.show_email ? "<span>".concat(this.$t ? this.$t('Email') : 'Email', " : ").concat(set.email || '', " <br></span>") : '', "\n          ").concat(ps && ps.show_phone ? "<span>".concat(this.$t ? this.$t('Phone') : 'Phone', " : ").concat(set.CompanyPhone || '', " <br></span>") : '', "\n          ").concat(ps && ps.show_customer ? "<span>".concat(this.$t ? this.$t('Customer') : 'Customer', " : ").concat(s.client_name || '', " <br></span>") : '', "\n          ").concat(ps && ps.show_Warehouse ? "<span>".concat(this.$t ? this.$t('warehouse') : 'Warehouse', " : ").concat(s.warehouse_name || '', " <br></span>") : '', "\n        ");
      var legalCopy = ps && ps.show_note ? "\n          <div id=\"legalcopy\" class=\"ml-2\">\n            <p class=\"legal\"><strong>".concat(ps.note_customer || '', "</strong></p>\n          </div>\n        ") : '';
      var refLine = s && s.Ref ? "<div class=\"mt-1\" style=\"font-size:10px;\">Ref: ".concat(s.Ref, "</div>") : '';
      var html = "\n          <div id=\"invoice-POS\">\n            <div style=\"max-width:400px;margin:0 auto\">\n              <div class=\"info\">\n                <div class=\"invoice_logo text-center mb-2\">\n                  ".concat(set.logo ? "<img src=\"/images/".concat(set.logo, "\" alt width=\"60\" height=\"60\">") : '', "\n                </div>\n                <p>").concat(contactLines, "</p>\n              </div>\n              <table class=\"table_data\"><tbody>\n                ").concat(rows, "\n                ").concat(totals, "\n              </tbody></table>\n              ").concat(paymentsTable, "\n              ").concat(legalCopy, "\n              ").concat(refLine, "\n            </div>\n          </div>\n        ");
      var a = window.open('', '', 'height=600,width=480');
      if (!a) {
        return;
      }
      ...
      a.document.write('</body></html>');
      a.document.close();
      var _reloadParent2 = function reloadParent() {
        try {
          window.removeEventListener('focus', _reloadParent2);
        } catch (e) {}
        try {
          a.close();
        } catch (e) {}
      ...
      try {
        window.addEventListener('focus', _reloadParent2);
      } catch (e) {}
      try {
        a.onafterprint = _reloadParent2;
      } catch (e) {}
      setTimeout(function () {
        try {
          a.focus();
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      if (response.data.defaultWarehouse != "") {
        _this39.Get_Products_By_Warehouse(response.data.defaultWarehouse);
      }
    ...
    if (!stockCheck.ok) {
      var msg = this.$t ? "".concat(this.$t('InsufficientStock'), " ").concat(stockCheck.productName) : "Insufficient stock for ".concat(stockCheck.productName);
    ...
    if (Number(this.GrandTotal) < 0) {
      var _msg = this.$t ? "".concat(this.$t('pos.Total_Payable'), " cannot be negative") : 'Total Payable cannot be negative';
      this.makeToast('warning', _msg, this.$t ? this.$t('Warning') : 'Warning');
      return;
    }
  ...
  created: function created() {
    ...
    this.$watch('warehouses', function (ws) {
      _this40.warehouseOptions = (ws || []).map(function (w) {
        return {
          value: w.id,
          text: w.name
        };
      });
      if (!_this40.registerForm.warehouse_id && _this40.sale && _this40.sale.warehouse_id) {
        _this40.registerForm.warehouse_id = _this40.sale.warehouse_id;
      }
      // Always check current register after initial data load
      _this40.refreshCurrentRegister();
    });
    // refresh register when warehouse changes
    this.$watch(function () {
      return _this40.sale.warehouse_id;
    }, function () {
      _this40.registerForm.warehouse_id = _this40.sale.warehouse_id || '';
      _this40.refreshCurrentRegister();
    });
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        ...
        if (Number(_this40.GrandTotal) < 0) {
          var msg = _this40.$t ? "".concat(_this40.$t('pos.Total_Payable'), " cannot be negative") : 'Total Payable cannot be negative';
          _this40.makeToast('warning', msg, _this40.$t ? _this40.$t('Warning') : 'Warning');
          // Complete the animation of the progress bar.
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
          return;
        }
        _this40.paymentLines = [{
          amount: parseFloat(_this40.GrandTotal.toFixed(2)),
          payment_method_id: 2
        }];
        _this40.globalPaymentNote = '';
        _this40.selectedAccount = null;
        _this40.$bvModal.show("Add_Payment");
        // Complete the animation of theprogress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      }, 500);
    });
    Fire.$on("event_delete_draft_sale", function () {
      _this40.get_Draft_Sales(_this40.serverParams.page);
      // Complete the animation of theprogress bar.
      setTimeout(function () {
        return nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      }, 500);
...
var render = function render() {
  ...
  return _c('div', {
    ...
    return _c('div', {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Payment')) + " #" + _vm._s(idx + 1))]), _vm._v(" "), _vm.paymentLines.length > 1 ? _c('button', {
      ...
      staticClass: "cc-actions"
    }, [_vm.localSavedPaymentMethods && _vm.localSavedPaymentMethods.length && !_vm.isSavedMode(idx) ? _c('button', {
      staticClass: "action-btn cancel-btn",
      attrs: {
        "type": "button"
      },
      on: {
        "click": function click($event) {
          return _vm.show_saved_credit_card(idx);
        }
      }
    }, [_c('i', {
      staticClass: "i-Two-Windows"
    }), _vm._v(" " + _vm._s(_vm.$t('Use_Saved_Credit_Card')) + "\n                            ")]) : _vm._e(), _vm._v(" "), _vm.isSavedMode(idx) ? _c('button', {
      staticClass: "action-btn cancel-btn",
      attrs: {
        "type": "button"
      },
      on: {
        "click": function click($event) {
          return _vm.show_new_credit_card(idx);
        }
      }
    }, [_c('i', {
      staticClass: "i-Add"
    }), _vm._v(" " + _vm._s(_vm.$t('Enter_New_Credit_Card')) + "\n                            ")]) : _vm._e()])]), _vm._v(" "), _vm.isLineLoadingSavedCards(idx) ? _c('div', {
      staticClass: "mt-2"
    }, [_c('div', {
      staticClass: "spinner sm spinner-primary"
    })]) : _vm._e(), _vm._v(" "), _vm.isSavedMode(idx) && !_vm.isLineLoadingSavedCards(idx) ? _c('div', [_c('div', {
      staticClass: "saved-cards"
    }, [_c('div', {
      staticClass: "saved-cards-header"
    }, [_vm._v(_vm._s(_vm.$t('Saved_Credit_Cards')))]), _vm._v(" "), _c('table', {
      staticClass: "table table-sm saved-cards-table"
    }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('Brand')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Last4')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Exp')))]), _vm._v(" "), _c('th')])]), _vm._v(" "), _c('tbody', _vm._l(_vm.localSavedPaymentMethods, function (card) {
      return _c('tr', {
        key: card.card_id,
        "class": {
          'bg-selected-card': _vm.isSelectedCardForLine(card, idx)
        }
      }, [_c('td', [_vm._v("\n                                    " + _vm._s(card.brand || card.card_brand || _vm.$t('Card')) + "\n                                    "), _vm.localSavedPaymentMethods.length > 1 && String(_vm.card_id) === String(card.card_id) ? _c('span', {
        staticClass: "default-badge"
      }, [_vm._v(_vm._s(_vm.$t('Default')))]) : _vm._e(), _vm._v(" "), _vm.isSelectedCardForLine(card, idx) ? _c('span', {
        staticClass: "selected-badge"
      }, [_vm._v(_vm._s(_vm.$t('Selected')))]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(card.last4 || card.card_last4 || '****'))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.formatCardExpiry(card)))]), _vm._v(" "), _c('td', {
        staticClass: "text-right"
      }, [!_vm.isSelectedCardForLine(card, idx) ? [_c('b-button', {
        attrs: {
          "size": "sm",
        ...
        on: {
          "click": function click($event) {
            return _vm.selectCardForLine(card, idx);
          }
        }
      }, [_c('i', {
        staticClass: "i-Yes"
      }), _vm._v(" " + _vm._s(_vm.$t('Use_This')) + "\n                                      ")])] : [_c('i', {
        staticClass: "i-Yes",
        staticStyle: {
          "font-size": "20px"
        }
      })]], 2)]);
    }), 0)])])]) : _vm._e(), _vm._v(" "), !_vm.isSavedMode(idx) && !_vm.isLineLoadingSavedCards(idx) ? _c('div', [_c('div', {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Card_Info_Secure_Stripe')))])])]) : _vm._e()])]) : _vm._e()])]);
...
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm.registerEnabled ? _c('div', {
    staticClass: "register-status"
  }, [_c('span', {
    staticClass: "mr-2"
  }, [_vm.currentRegister && _vm.currentRegister.status === 'open' ? _c('span', [_vm._v("🟢 " + _vm._s(_vm.$t('Open')))]) : _c('span', [_vm._v("🔴 " + _vm._s(_vm.$t('Closed')))])]), _vm._v(" "), _c('b-button', {
  ...
  }, [_vm.currentRegister && _vm.currentRegister.status === 'open' ? _c('span', [_vm._v(_vm._s(_vm.$t('Close Register')))]) : _c('span', [_vm._v(_vm._s(_vm.$t('Open Register')))])])], 1) : _vm._e(), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      "change": [function ($event) {
        ...
        _vm.$set(_vm.sale, "warehouse_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, function ($event) {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Select_Warehouse')))]), _vm._v(" "), _vm._l(_vm.warehouses, function (wh) {
    return _c('option', {
      key: wh.id,
      domProps: {
        "value": wh.id
    ...
    staticClass: "customer-select-header",
    on: {
      "change": [function ($event) {
        var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
          return o.selected;
        ...
        _vm.selectedClientId = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }, function ($event) {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Select_Customer')))]), _vm._v(" "), _vm._l(_vm.clients, function (client) {
    return _c('option', {
      key: client.id,
      domProps: {
        "value": client.id
  ...
  }), 0)])], 1) : _vm._e(), _vm._v(" "), _vm.currentUserPermissions && _vm.currentUserPermissions.includes('pos_settings') ? _c('router-link', {
    staticClass: "action-btn-icon btn-pos-settings",
    attrs: {
      "to": "/app/settings/pos_settings",
      "title": _vm.$t('POS_Settings')
  ...
  }, [_vm._v(_vm._s(_vm.$t('logout')))])], 1)])], 1)], 1)]), _vm._v(" "), _vm.registerEnabled ? _c('div', {
  ...
  }, [_vm.currentRegister && _vm.currentRegister.status === 'open' ? _c('span', [_vm._v(_vm._s(_vm.$t('Close Register')))]) : _c('span', [_vm._v(_vm._s(_vm.$t('Open Register')))])])], 1)]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "mobile-row"
  }, [_c('select', {
    directives: [{
      name: "model",
    ...
    }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(item.Total_price, 2)))]), _vm._v(" "), _c('select', {
      directives: [{
        name: "model",
        rawName: "v-model",
    ...
    }, [_vm._v(_vm._s(_vm.$t('Wholesale Price')))])])])])]);
  }), 0)]), _vm._v(" "), _c('div', {
    ...
    staticClass: "input-suffix"
  }, [_vm._v(_vm._s(_vm.currentUser.currency))])])]), _vm._v(" "), _c('div', {
    ...
    staticClass: "input-suffix"
  }, [_vm._v(_vm._s(_vm.currentUser.currency))])])]), _vm._v(" "), _vm.clientIsEligible && _vm.currentUserPermissions && _vm.currentUserPermissions.includes('edit_tax_discount_shipping_sale') ? _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.formatNumber(_vm.total, 2)))])]), _vm._v(" "), _c('div', {
    staticClass: "total-row"
  }, [_c('span', {
    staticClass: "total-label"
  }, [_vm._v(_vm._s(_vm.$t('pos.Tax')))]), _vm._v(" "), _c('span', {
    staticClass: "total-value"
  }, [_vm._v(_vm._s(_vm.formatNumber(_vm.sale.TaxNet, 2)))])]), _vm._v(" "), _c('div', {
    staticClass: "total-row"
  }, [_c('span', {
  ...
  }, [_vm._v("-" + _vm._s(_vm.formatNumber(_vm.sale.discount, 2)))])]), _vm._v(" "), _c('div', {
    staticClass: "total-row"
  }, [_c('span', {
    staticClass: "total-label"
  }, [_vm._v(_vm._s(_vm.$t('pos.Shipping')))]), _vm._v(" "), _c('span', {
    staticClass: "total-value"
  }, [_vm._v(_vm._s(_vm.formatNumber(_vm.sale.shipping, 2)))])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.formatNumber(_vm.GrandTotal, 2)))])])])])])]), _vm._v(" "), _c('div', {
    ...
    attrs: {
      ...
      "saved-payment-methods": _vm.savedPaymentMethods,
  ...
  })]), _vm._v(" "), _c('p', [_c('span', [_vm._v(_vm._s(_vm.$t('date')) + " : " + _vm._s(_vm.invoice_pos.sale.date) + " "), _c('br')]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.$t('Seller')) + " : " + _vm._s(_vm.invoice_pos.sale.seller_name) + " "), _c('br')]), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    staticClass: "legal"
  }, [_c('strong', [_vm._v(_vm._s(_vm.pos_settings.note_customer))])]), _vm._v(" "), _vm.invoice_pos.setting && _vm.invoice_pos.setting.zatca_enabled && _vm.invoice_pos.zatca_qr ? _c('div', {
    ...
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.$t('Action')))])])]), _vm._v(" "), _c('tbody', _vm._l(_vm.draft_sales, function (d) {
    return _c('tr', {
      key: d.id
  ...
  }, [_vm._v(_vm._s(_vm.$t('Save')))])], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c('b-modal', {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.today_sales.total_sales_amount || 0, 2)))])])]), _vm._v(" "), _c('div', {
    staticClass: "ts-card"
  }, [_c('div', {
    ...
    staticClass: "ts-value"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.today_sales.total_amount_paid || 0, 2)))])])]), _vm._v(" "), _c('div', {
    staticClass: "ts-card"
  }, [_c('div', {
    staticClass: "ts-icon warning"
  }, [_c('i', {
    staticClass: "i-Money"
  })]), _vm._v(" "), _c('div', {
    staticClass: "ts-content"
    ...
    staticClass: "ts-label"
  }, [_vm._v(_vm._s(_vm.$t('Cash')))]), _vm._v(" "), _c('div', {
    staticClass: "ts-value"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.today_sales.total_cash || 0, 2)))])])]), _vm._v(" "), _c('div', {
    staticClass: "ts-card"
  }, [_c('div', {
    ...
    staticClass: "ts-value"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.today_sales.total_credit_card || 0, 2)))])])]), _vm._v(" "), _c('div', {
    staticClass: "ts-card"
  }, [_c('div', {
    staticClass: "ts-icon danger"
  }, [_c('i', {
    staticClass: "i-File"
  })]), _vm._v(" "), _c('div', {
    staticClass: "ts-content"
    ...
    staticClass: "ts-label"
  }, [_vm._v(_vm._s(_vm.$t('Cheque')))]), _vm._v(" "), _c('div', {
    staticClass: "ts-value"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.today_sales.total_cheque || 0, 2)))])])])])]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v("-" + _vm._s(product.discount) + "%")]) : _vm._e()]), _vm._v(" "), _c('div', {
      staticClass: "product-details"
    }, [_c('h4', {
      staticClass: "product-name"
    }, [_vm._v(_vm._s(product.name))]), _vm._v(" "), _c('p', {
      staticClass: "product-brand"
    }, [_vm._v(_vm._s(product.code))]), _vm._v(" "), product.product_type !== 'is_service' ? _c('p', {
    ...
    }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(product.Net_price, 2)))]), _vm._v(" "), _c('button', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Close Register')))])], 1)]), _vm._v(" "), _vm.productsReady ? _c('div', {
  ...
  })]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.$t('pos.Home')))])]), _vm._v(" "), _c('button', {
    staticClass: "action-btn action-btn-secondary",
    attrs: {
  ...
  })]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.$t('pos.Reset')))])]), _vm._v(" "), _c('button', {
    staticClass: "action-btn action-btn-secondary",
    attrs: {
  ...
  })]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.$t('pos.Recent_Drafts')))])]), _vm._v(" "), _c('button', {
    staticClass: "action-btn action-btn-secondary",
    attrs: {
  ...
  })]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.DraftProcessing ? _vm.$t('pos.Saving') : _vm.$t('pos.Hold')))])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.formatNumber(_vm.GrandTotal, 2)))])]), _vm._v(" "), _c('button', {
